...
import {todolistActions, todolistsSlice} from '../../../index';
...
test('correct todolist should be removed', () => {
    const endState = todolistsSlice(startState, removeTodolist.fulfilled({todolistId: todolistId1}, '', todolistId1));
...
test('correct todolist should be added', () => {
    ...
    const endState = todolistsSlice(startState, addTodolist.fulfilled(
